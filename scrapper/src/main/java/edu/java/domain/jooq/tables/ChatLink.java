...
public class ChatLink extends TableImpl<ChatLinkRecord> {
    ...
    public List<ForeignKey<ChatLinkRecord, ?>> getReferences() {
        return Arrays.asList(Keys.CHAT_LINK__CHAT_LINK_CHAT_FKEY, Keys.CHAT_LINK__CHAT_LINK_LINK_FKEY);
    }
    ...
    public Chat chat() {
        if (_chat == null)
            _chat = new Chat(this, Keys.CHAT_LINK__CHAT_LINK_CHAT_FKEY);
    ...
    public Link link() {
        if (_link == null)
            _link = new Link(this, Keys.CHAT_LINK__CHAT_LINK_LINK_FKEY);
